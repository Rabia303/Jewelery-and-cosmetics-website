...
if (isset($_POST['login'])) {
	...
	if ($row) {
		$user_id = $fetch['u_id']; // Define $user_id and set it to the user's ID
												...
												<form method="post" class="login">
													...
													<div class="rememberme-lost">
														<div class="remember-me">
															<a href="page-register.php">Don't have an account?</a>
														</div>
...
<!-- Mirrored from caketheme.com/html/mojuri/page-login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 06 Sep 2023 18:39:44 GMT -->
