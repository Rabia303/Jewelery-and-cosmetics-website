...
if (isset($_POST['sub'])) {
    ...
    $sql = "INSERT INTO `add_prod_cosmetics`(`p_name`, `p_price`, `p_desc`,
     `c_id`, `p_img`, `quantity`, `Variants(size/color)`, `discount`) VALUES ('$pname',
    '$pprice','$desc','$pcat','$img','$qnty','$size','$sale')";

    move_uploaded_file($imgt, "prodimages-cosmetics/" . $img);
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select name="cid" class="form-control">
                                                        <?php
                                                        include('conn.php');
                                                        $sql = "SELECT * FROM `add_cat_cosmetics`";
